   ...
   <div class="container-fluid">
      <div class="row  justify-content-center align-items-center d-flex text-center h-100">
        <div class="col-12 col-md-8  h-50 ">
            ...
            <p class="lead  text-light mb-5">Accédez à tous nos produits à des prix défiants toute concurrence</p>
<p><a href="{{ route ('produits.index') }}" class="btn bg-danger shadow-lg btn-round text-light btn-lg btn-rised">Consulter nos produits</a></p>
      ...
      <div class="row">
         ...
         @foreach($produits as $produit)
             <div class="col-md-4">
              <div class="card">
                  <img class="card-img-top" src=" {{ $produit->image ? asset('storage/uploads/produits/'.$produit->image):  'https://picsum.photos/100/150'}}"  alt="">
                  <div class="card-body">
